package com.example.parse.core.component;
...
/**
 * just my ErrorHandle for restTemplate in spring boot we cannot handle query with bad status,
 * it create an error, so i just hidden it, it's not good but work
 */
@Component
